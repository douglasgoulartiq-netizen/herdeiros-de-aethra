...
export const ECOLOGIA = {
  ...
  // --- chefes de zona do mundo 4x (gerado: gen_ecologia_chefes.mjs) ---
  primeira_voz: { habitats: ["mata"], horario: "sempre", clima: [], climaFoge: [], dieta: ["lobo","corvo_ceifador","abelha_titan","carnica"], ameaca: "apice", eter: 2, grupo: [1, 1], descoberta: "eco que responde errado" },
  touro_da_colheita: { habitats: ["campo"], horario: "sempre", clima: [], climaFoge: [], dieta: ["goblin","bandido","javali","carnica"], ameaca: "apice", eter: 2, grupo: [1, 1], descoberta: "lavoura aberta em linha reta" },
  alcateia_branca: { habitats: ["gelo","rocha"], horario: "sempre", clima: [], climaFoge: [], dieta: ["lobo_gelido","bruxa_da_bruma","harpia","carnica"], ameaca: "apice", eter: 1, grupo: [1, 1], descoberta: "uivo em coro sem origem" },
  primeira_brasa: { habitats: ["vulcanico","rocha"], horario: "sempre", clima: [], climaFoge: [], dieta: ["senhor_da_cinza","gargula","golem_de_pedra","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "brasa que nunca apagou" },
  capataz_de_pedra: { habitats: ["vulcanico","rocha","caverna"], horario: "sempre", clima: [], climaFoge: [], dieta: ["golem_de_pedra","troll_das_cavernas","gargula","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "picareta batendo sozinha" },
  reflexo_afogado: { habitats: ["mata","agua_aberta","brejo"], horario: "sempre", clima: [], climaFoge: [], dieta: ["sapo_venenoso","lodo_negro","druida_corrompido","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "reflexo atrasado" },
  porteiro_de_casca: { habitats: ["mata"], horario: "sempre", clima: [], climaFoge: [], dieta: ["lobo","javali","corvo_ceifador","carnica"], ameaca: "apice", eter: 2, grupo: [1, 1], descoberta: "portão que se fecha um palmo" },
  cortador_de_cordas: { habitats: ["altitude","rocha"], horario: "sempre", clima: [], climaFoge: [], dieta: ["harpia","grifo_jovem","gralha_tempestuosa","carnica"], ameaca: "apice", eter: 1, grupo: [1, 1], descoberta: "corda arrebentada sem vento" },
  engrenagem_mestra: { habitats: ["ruina","caverna"], horario: "sempre", clima: [], climaFoge: [], dieta: ["construto_arcano","sentinela_arcana","gargula","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "corredor que gira" },
  veia_negra: { habitats: ["vulcanico","rocha","caverna"], horario: "sempre", clima: [], climaFoge: [], dieta: ["golem_de_pedra","orc_selvagem","troll_das_cavernas","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "parede que respira" },
  dona_do_poco: { habitats: ["deserto","campo","agua_aberta"], horario: "sempre", clima: [], climaFoge: [], dieta: ["bandido","escorpiao_gigante","harpia","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "sombra a mais entre as palmeiras" },
  rei_sob_a_areia: { habitats: ["deserto","ruina"], horario: "sempre", clima: [], climaFoge: [], dieta: ["necromante_errante","esqueleto","verme_das_dunas","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "torre subindo da areia" },
  vigia_do_penhasco: { habitats: ["costa","altitude","rocha"], horario: "sempre", clima: [], climaFoge: [], dieta: ["harpia","pirata_naufrago","serpente_marinha","carnica"], ameaca: "apice", eter: 1, grupo: [1, 1], descoberta: "aviso de tempestade sem nuvem" },
  jardineira_de_perola: { habitats: ["costa","agua_aberta"], horario: "sempre", clima: [], climaFoge: [], dieta: ["caranguejo_gigante","enguia_eletrica","arraia_relampago","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "coral que se fecha atrás" },
  sentinela_das_seis_correntes: { habitats: ["agua_aberta","ruina"], horario: "sempre", clima: [], climaFoge: [], dieta: ["cristal_ecoante","wisp_radiante","espectro_arcano","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "seis águas paradas ao mesmo tempo" },
  eco_de_seis_cores: { habitats: ["agua_aberta","campo","brejo"], horario: "sempre", clima: [], climaFoge: [], dieta: ["sapo_venenoso","lodo_negro","cristal_ecoante","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "margem que troca de cor" },
  tecela_do_brejo: { habitats: ["brejo","caverna"], horario: "sempre", clima: [], climaFoge: [], dieta: ["lodo_negro","aranha_gigante","druida_corrompido","carnica"], ameaca: "apice", eter: 1, grupo: [1, 1], descoberta: "esporos em sequência" },
  oficiante_do_oco: { habitats: ["mata","veu"], horario: "sempre", clima: [], climaFoge: [], dieta: ["lobo_sombrio","druida_corrompido","corvo_ceifador","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "velas acesas sem pegada" },
  campea_invicta: { habitats: ["ossario","campo"], horario: "sempre", clima: [], climaFoge: [], dieta: ["golem_de_pedra","esqueleto","troll_das_cavernas","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "pegadas que só saem" },
  coracao_que_bate: { habitats: ["ossario","rocha","ruina"], horario: "sempre", clima: [], climaFoge: [], dieta: ["golem_de_pedra","construto_arcano","gargula","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "pulso no chão" },
  coro_dos_lamentos: { habitats: ["veu","rocha","ossario"], horario: "sempre", clima: [], climaFoge: [], dieta: ["espectro_arcano","gargula","carrasco_de_cinzas","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "passo devolvido como choro" },
  wyvern_de_obsidiana: { habitats: ["veu","altitude","rocha"], horario: "sempre", clima: [], climaFoge: [], dieta: ["wyvern","golem_de_pedra","troll_das_cavernas","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "sombra que não sai do outro lado" },
  guardia_das_ilhas: { habitats: ["altitude","campo"], horario: "sempre", clima: [], climaFoge: [], dieta: ["grifo_jovem","gralha_tempestuosa","harpia","carnica"], ameaca: "apice", eter: 1, grupo: [1, 1], descoberta: "grifos alinhados" },
  o_que_olha_de_volta: { habitats: ["agua_aberta","veu"], horario: "sempre", clima: [], climaFoge: [], dieta: ["serpente_marinha","espectro_arcano","construto_arcano","carnica"], ameaca: "apice", eter: 3, grupo: [1, 1], descoberta: "vórtice que para de girar" },
  ancora_viva: { habitats: ["agua_aberta","costa","ruina"], horario: "sempre", clima: [], climaFoge: [], dieta: ["serpente_marinha","enguia_eletrica","arraia_relampago","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "âncora que se enrola" },
  ultimo_sacerdote: { habitats: ["ossario","rocha","ruina"], horario: "sempre", clima: [], climaFoge: [], dieta: ["golem_de_pedra","esqueleto","cristal_ecoante","carnica"], ameaca: "apice", eter: 0, grupo: [1, 1], descoberta: "reza em muitas vozes" },
  // --- fim dos chefes de zona do mundo 4x ---
};
